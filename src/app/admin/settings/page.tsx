...
import { getSettings, stripeConfigured } from '@/lib/settings';
  ...
  return (
    <main className="mx-auto max-w-[800px] px-6 py-10">
      ...
      <p className="m-0 mb-8 text-[15px] leading-[1.7] text-ink-soft">
        Night hours, online payment and the site’s contact details.
      </p>
        ...
        <table className="w-full border-collapse text-sm">
          <tbody>
            {[
              ...
              ['Booking emails delivered to', process.env.MAIL_TO || site.email, 'MAIL_TO'],
              ['SMTP server', process.env.SMTP_HOST || 'not configured (console mode)', 'SMTP_HOST'],
