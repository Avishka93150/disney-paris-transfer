...
export function BookingForm({
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="flex flex-col gap-5 rounded-[20px] border border-line bg-surface p-8"
    >
      ...
      {/* Anti-bot honeypot: invisible and hidden from screen readers. */}
        ...
        {estimate ? (
          <div className="flex flex-col gap-1.5 text-sm">
            ...
            <div className="mt-1 flex items-baseline justify-between gap-4 border-t border-line-strong pt-2">
              ...
              <span className="font-display text-[26px] text-brand">
                {euros(estimate.totalCents)}
              </span>
            </div>
          </div>
        ) : (
      ...
      <button
        ...
        className="cursor-pointer rounded-full border-none bg-brand px-6 py-[15px] font-sans text-[17px] font-extrabold text-surface hover:bg-brand-dark disabled:opacity-60"
      >
